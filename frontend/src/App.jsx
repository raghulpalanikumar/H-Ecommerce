    ...
    <div className="role-selection-wrapper">
      <div className="role-selection-container">
        <header className="role-selection-header">
          <h1>Welcome to Modern Mobiles</h1>
        ...
        <div className="role-cards-grid">
          <div className="role-card" onClick={() => onRoleSelect('user')}>
            ...
            <h3>Customer Mode</h3>
            <p>Shop the latest high-performance smartphones and accessories.</p>
            <button className="role-btn">Access Store</button>
          </div>
          ...
          <div className="role-card" onClick={() => onRoleSelect('admin')}>
            ...
            <h3>Admin Portal</h3>
            <p>Manage inventory, orders, and system analytics securely.</p>
